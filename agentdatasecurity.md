...
flowchart TD
    ...
    A1[Structured Data (e.g., JSON)]:::dataSources --> A
    A2[Unstructured Data (e.g., Text)]:::dataSources --> A
    A3[Sensitive Data (e.g., PII)]:::dataSources --> A
